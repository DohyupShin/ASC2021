...
\begin{document}
    ...
    \begin{itemize}
        ...
        In summary, \\
        fiting value $\hat y_0$ =  7790.976 \\
        fiting value $\hat y_1$  =  1375.237 \\
        fiting value $\hat y_2$  =  242.7523 \\
        fiting value $\hat y_3$  =  42.84982 \\
        fiting value $\hat y_4$  =  7.563708 \\
        fiting value $\hat y_5$  =  1.33512 \\
        fiting value $\hat y_6$  =  0.235671 \\
        fiting value $\hat y_7$  =  0.04159986 \\
        ...
        fiting value $\hat{E} \{ \theta|x = 0 \}$ =  0.1765167 \\
        fiting value $\hat{E} \{ \theta|x = 1 \}$ =  0.3530333 \\
        fiting value $\hat{E} \{ \theta|x = 2 \}$ =  0.5295500 \\
        fiting value $\hat{E} \{ \theta|x = 3 \}$ =  0.7060667 \\
        fiting value $\hat{E} \{ \theta|x = 4 \}$ =  0.8825833 \\
        fiting value $\hat{E} \{ \theta|x = 5 \}$ =  1.0591000 \\
        fiting value $\hat{E} \{ \theta|x = 6 \}$ =  1.2356167 \\
